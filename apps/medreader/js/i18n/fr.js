...
export default {
  ...
  'reader.view.reflow': 'Texte',
  'reader.original.zoomIn': 'Agrandir',
  'reader.original.zoomOut': 'Réduire',
  'reader.original.zoom': '{percent} %',
  'reader.original.loading': 'Ouverture de la page originale…',
  'reader.original.failed': 'Cette page ne peut pas être affichée telle quelle.',
  'reader.original.canvas': 'Page originale {page}',
  'reader.table.crop': 'Image du tableau tirée de la page originale',
  'reader.table.cropFailed': 'Tableau (image impossible à créer)',
  ...
  'reader.tts.tableSkipped': 'Voici un tableau. Regardez l’écran.',
  /* ── 퀴즈 (5-5 · 16-E) — 9b 단계 ───────────────── */
  'quiz.section.fallback': 'Section {id}',
  'quiz.progress': 'Question {index} sur {total}',
  'quiz.question.number': 'Question {number}',
  'quiz.badge.verified': 'Réponse du livre',
  'quiz.badge.unverified': 'Réponse non confirmée',
  'quiz.unverified.help': "Cette question n'est pas corrigée. Vérifiez la réponse dans le texte original.",
  'quiz.unverified.goToPage': 'Aller à la page {page}',
  'quiz.answer.correct': 'Correct',
  'quiz.answer.wrong': 'Incorrect',
  'quiz.answer.expected': 'Réponse du livre : {letters}',
  'quiz.explanation.title': 'Explication',
  'quiz.explanation.none': "Le livre ne donne pas d'explication pour cette question.",
  'quiz.explanation.speak': 'Écouter',
  'quiz.explanation.stop': 'Arrêter',
  'quiz.next': 'Suivant',
  'quiz.finish': 'Voir le résultat',
  'quiz.result.title': 'Résultat',
  'quiz.result.score': 'Score {score} sur {total}',
  'quiz.result.ungraded.one': '{n} question non corrigée.',
  'quiz.result.ungraded.other': '{n} questions non corrigées.',
  'quiz.result.wrong.title': 'À revoir',
  'quiz.result.allCorrect': 'Toutes les questions corrigées sont justes.',
  'quiz.result.retryWrong': 'Refaire mes erreurs',
  'quiz.result.backToReader': 'Retour à la lecture',
  ...
  'quiz.pager.label': 'Navigation des questions',
  'quiz.pager.prev': 'Précédent',
  'quiz.pager.next': 'Suivant',
  'quiz.pager.jump': 'Aller à la question',
  'quiz.pager.of': 'sur {n}',
  'quiz.chip.open': 'Faire le quiz de cette section',
  'quiz.chip.meta.one': '{n} question',
  'quiz.chip.meta.other': '{n} questions',
  'quiz.chip.dismiss': 'Pas maintenant',
