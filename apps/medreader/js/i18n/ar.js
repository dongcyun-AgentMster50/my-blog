...
export default {
  ...
  /* ── 퀴즈 (5-5 · 16-E) — 9b 단계 ───────────────── */
  'quiz.section.fallback': 'القسم {id}',
  'quiz.progress': 'السؤال {index} من {total}',
  'quiz.question.number': 'السؤال {number}',
  'quiz.badge.verified': 'الإجابة من الكتاب',
  'quiz.badge.unverified': 'الإجابة غير مؤكدة',
  'quiz.unverified.help': 'لا يُصحَّح هذا السؤال. تحقّق من الإجابة في النص الأصلي.',
  'quiz.unverified.goToPage': 'اذهب إلى صفحة {page}',
  'quiz.answer.correct': 'إجابة صحيحة',
  'quiz.answer.wrong': 'إجابة غير صحيحة',
  'quiz.answer.expected': 'إجابة الكتاب: {letters}',
  'quiz.explanation.title': 'الشرح',
  'quiz.explanation.none': 'لا يقدّم الكتاب شرحًا لهذا السؤال.',
  'quiz.explanation.speak': 'استمع',
  'quiz.explanation.stop': 'إيقاف',
  'quiz.next': 'التالي',
  'quiz.finish': 'اعرض النتيجة',
  'quiz.result.title': 'النتيجة',
  'quiz.result.score': 'النتيجة {score} من {total}',
  'quiz.result.ungraded.one': 'سؤال واحد لم يُصحَّح.',
  'quiz.result.ungraded.other': '{n} أسئلة لم تُصحَّح.',
  'quiz.result.wrong.title': 'راجع هذه الأسئلة',
  'quiz.result.allCorrect': 'كل سؤال مُصحَّح كان صحيحًا.',
  'quiz.result.retryWrong': 'أعد الأسئلة الخاطئة',
  'quiz.result.backToReader': 'العودة إلى القراءة',
  ...
  'quiz.pager.label': 'التنقل بين الأسئلة',
  'quiz.pager.prev': 'السابق',
  'quiz.pager.next': 'التالي',
  'quiz.pager.jump': 'الانتقال إلى السؤال',
  'quiz.pager.of': 'من {n}',
  'quiz.chip.open': 'اختبر نفسك في هذا القسم',
  'quiz.chip.meta.one': 'سؤال واحد',
  'quiz.chip.meta.other': '{n} أسئلة',
  'quiz.chip.dismiss': 'ليس الآن',
