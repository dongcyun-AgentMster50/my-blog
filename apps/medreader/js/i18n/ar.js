...
export default {
  ...
  /* ── العرض الأصلي · صورة الجدول (12-5 · 4-8) ────── */
  'reader.view.original': 'الأصل',
  'reader.view.reflow': 'النص',
  'reader.original.zoomIn': 'تكبير',
  'reader.original.zoomOut': 'تصغير',
  'reader.original.zoom': '{percent}٪',
  'reader.original.loading': 'جارٍ فتح الصفحة الأصلية…',
  'reader.original.failed': 'تعذّر عرض هذه الصفحة بشكلها الأصلي.',
  'reader.original.canvas': 'الصفحة الأصلية {page}',
  'reader.table.crop': 'صورة الجدول من الصفحة الأصلية',
  'reader.table.cropFailed': 'جدول (تعذّر إنشاء الصورة)',
  ...
  /* ── القراءة الصوتية (6-1 · 6-3 · 6-4 · 6-5 · 12-3) ─── */
  'reader.tts.bar': 'القراءة الصوتية',
  'reader.tts.play': 'تشغيل',
  'reader.tts.pause': 'إيقاف مؤقت',
  'reader.tts.prev': 'للخلف',
  'reader.tts.next': 'للأمام',
  'reader.tts.rate': 'السرعة',
  // RTL 에서는 배율 기호가 숫자 앞에 온다.
  'reader.tts.rate.value': '×{rate}',
  'reader.tts.progress': 'السطر {index} من {total}',
  'reader.tts.unit': 'وحدة القراءة',
  'reader.tts.unit.sentence': 'جملة',
  'reader.tts.unit.line': 'سطر',
  /* التكرار (5b) — الصفر يعني بلا نهاية. */
  'reader.tts.repeat': 'التكرار',
  'reader.tts.repeat.off': 'إيقاف',
  'reader.tts.repeat.unit': 'جملة واحدة',
  'reader.tts.repeat.range': 'مقطع',
  'reader.tts.repeat.count': 'عدد المرات',
  'reader.tts.repeat.times': '{n} مرات',
  'reader.tts.repeat.endless': 'حتى الإيقاف',
  'reader.tts.repeat.span.label': 'المقطع',
  'reader.tts.repeat.span': 'من السطر {from} إلى السطر {to}',
  'reader.tts.repeat.from': 'البداية هنا',
  'reader.tts.repeat.to': 'النهاية هنا',
  'reader.tts.repeat.status': 'تكرار {done}/{total}',
  'reader.tts.repeat.statusEndless': 'التكرار مفعّل',
  ...
  'reader.tts.wakeLock': 'قد ينطفئ الشاشة أثناء القراءة. أطل مهلة إطفاء الشاشة في إعدادات الجهاز.',
  'reader.tts.unsupported': 'هذا المتصفّح لا يدعم القراءة الصوتية.',
  'reader.tts.tableSkipped': 'هذا جدول. انظر إلى الشاشة.',
